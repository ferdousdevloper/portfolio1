        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex justify-center backdrop-blur-xl rounded-4xl bg-white/60 dark:bg-gray-900/40 border border-gray-200/50 dark:border-white/10 shadow-neumorphic"
            >
            ...
            <motion.div
              ...
              transition={{ duration: 0.9 }}
              viewport={{ once: true }}
              className="rounded-3xl p-8 md:p-10 border border-gray-200/50 dark:border-white/10 backdrop-blur-xl bg-white/60 dark:bg-gray-900/40 shadow-neumorphic"
            >
              ...
              <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div className="p-4 rounded-xl bg-gray-100/80 dark:bg-gray-800/50 border border-gray-200/50 dark:border-white/10 shadow-neumorphic">
                  <p className="text-gray-900 dark:text-white font-semibold">5+ Years</p>
                  <p className="text-gray-600 dark:text-gray-400">Industry Experience</p>
                </div>

                <div className="p-4 rounded-xl bg-gray-100/80 dark:bg-gray-800/50 border border-gray-200/50 dark:border-white/10 shadow-neumorphic">
                  <p className="text-gray-900 dark:text-white font-semibold">Operations</p>
                  <p className="text-gray-600 dark:text-gray-400">Planning & Control</p>
                </div>

                <div className="p-4 rounded-xl bg-gray-100/80 dark:bg-gray-800/50 border border-gray-200/50 dark:border-white/10 shadow-neumorphic">
                  <p className="text-gray-900 dark:text-white font-semibold">Frontend</p>
                  <p className="text-gray-600 dark:text-gray-400">React Developer</p>
                </div>

                <div className="p-4 rounded-xl bg-gray-100/80 dark:bg-gray-800/50 border border-gray-200/50 dark:border-white/10 shadow-neumorphic">
                  <p className="text-gray-900 dark:text-white font-semibold">Growth</p>
                  <p className="text-gray-600 dark:text-gray-400">Continuous Learner</p>
                </div>
              </div>
            </motion.div>
          </div>
