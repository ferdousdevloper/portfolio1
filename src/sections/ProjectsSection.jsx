      ...
      <FadeIn>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex justify-center  mb-24">
            <div className="flex items-center gap-3 bg-fuchsia-600/15 dark:bg-fuchsia-600/20 text-fuchsia-600 dark:text-fuchsia-300 px-6 py-3 rounded-full border border-fuchsia-500/30 dark:border-fuchsia-500/40">
              <FaCode />
            ...
            {projects.map((project, index) => (
              ...
              >
                <Link to={`/projects/${project.id}`}>
                  <div className="relative overflow-hidden rounded-3xl border border-gray-200/50 dark:border-white/20 cursor-pointer hover-3d bg-white/60 dark:bg-gray-900/30 shadow-neumorphic">
                    {/* Image */}
                    <img
                      src={project.image}
