      ...
      <FadeIn>
        <div className="max-w-7xl mx-auto px-6">
          ...
          />
            ...
            {/* ================= ENGLISH PROFICIENCY ================= */}
          <div className="mt-28 bg-white/80 dark:bg-gray-900/40 p-10 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 relative backdrop-blur-xl">
            <div className="absolute -top-16 -right-16 w-48 h-48 bg-[#FFB800]/20 blur-3xl rounded-full" />
              ...
              {trainings.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="md:w-[48%] bg-white/80 dark:bg-gray-900/40 p-8 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 relative overflow-hidden backdrop-blur-xl">
          ...
          <div className="mt-28">
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-10 flex items-center gap-3">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {internships.map((item, index) => (
                <motion.div
                  ...
                  className="bg-white/80 dark:bg-gray-900/40 p-6 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 relative backdrop-blur-xl"
                >
