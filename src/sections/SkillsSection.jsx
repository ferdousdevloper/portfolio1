...
const SkillCard = ({ icon: Icon, title, description }) => (
  <div className="bg-white/80 dark:bg-gray-900/40 border border-gray-200/50 dark:border-white/10 rounded-3xl p-6 shadow-neumorphic hover:-translate-y-2 transition duration-500 backdrop-blur-xl">
    <div className="flex items-center gap-4 mb-4">
      <Icon className="text-3xl text-[#FFA500]" />
    ...
    <section className="max-w-7xl mx-auto px-6 py-32">
      ...
      <div className="mb-24">
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-10 flex items-center gap-3">
          <FaIndustry className="text-[#FFA500]" />
