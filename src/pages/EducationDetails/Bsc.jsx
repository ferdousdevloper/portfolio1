...
const Bsc = () => {
  return (
    <section className="md:my-0 my-32">
      {/* ===== Banner ===== */}
      ...
      <FadeIn>
        <div className="max-w-7xl mx-auto px-6 py-28">
          ...
          {/* ===== Overview ===== */}
          <div className="mt-16 p-8 rounded-3xl shadow-lg border border-white/10 relative bg-gray-900/40 backdrop-blur-xl">
            ...
            <h3 className="text-2xl text-white font-semibold mb-4 flex items-center gap-3">
          ...
          {/* ===== Academic Info ===== */}
          <div className="mt-12 p-8 rounded-3xl shadow-xl border border-white/10 bg-gray-900/40 grid md:grid-cols-2 gap-6 text-gray-300 backdrop-blur-xl">
          ...
          {/* ===== Academic Highlights ===== */}
          <div className="mt-12 p-8 rounded-3xl shadow-lg border border-white/10 relative bg-gray-900/40 backdrop-blur-xl">
            ...
            <ul className="grid md:grid-cols-2 list-disc list-inside gap-4 text-gray-400 leading-relaxed">
              <li>
          ...
          <div className="mt-12 p-8 rounded-3xl shadow-xl border border-white/10 bg-gray-900/40 backdrop-blur-xl">
            ...
            <div className="mb-16 relative">
              <div className="absolute -bottom-10 right-10  w-1/3   h-[144.67px] bg-fuchsia-600/40 opacity-33 blur-3xl rounded-full" />
            <div className="absolute -left-10   w-1/3 h-[144.67px] bg-[#FFB800] opacity-20 blur-3xl rounded-full" />
              <h4 className="text-xl font-semibold mb-4 flex items-center gap-3 text-white">
