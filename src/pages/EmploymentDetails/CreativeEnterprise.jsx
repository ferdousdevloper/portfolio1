      ...
      <FadeIn>
        <div className="max-w-7xl mx-auto px-6 py-28">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-16 bg-white-50 p-8 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 backdrop-blur-xl"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-12 bg-gray-900/40 p-8 rounded-3xl shadow-xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 backdrop-blur-xl"
          >
          ...
          >
            ...
            <ul className="grid md:grid-cols-2 gap-4 list-disc list-inside text-gray-400 leading-relaxed">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-20 bg-gray-900/40 p-6 rounded-3xl shadow-xl border border-white/10 backdrop-blur-xl"
          >
