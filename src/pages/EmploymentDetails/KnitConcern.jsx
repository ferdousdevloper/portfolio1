...
import img5 from "../../assets/knit/gallery5.jpg";
import img6 from "../../assets/knit/gallery6.jpg";
    ...
    <section className="mt-32 md:mt-0">
      ...
      <FadeIn>
        <div className="max-w-7xl mx-auto px-6 py-28">
          ...
          <div className="mt-16 bg-white/80 dark:bg-gray-900/40 p-8 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 backdrop-blur-xl">
            <h3 className="text-2xl text-gray-900 dark:text-white font-semibold mb-4 flex items-center gap-3">
          ...
          <div className="mt-12 bg-white/80 dark:bg-gray-900/40 p-8 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 grid md:grid-cols-2 gap-6 text-gray-700 dark:text-gray-300 backdrop-blur-xl">
          ...
          <div className="mt-12 bg-white/80 dark:bg-gray-900/40 p-8 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 backdrop-blur-xl">
            ...
            <ul className="grid md:grid-cols-2 list-disc list-inside gap-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              <li>
          ...
          <div className="mt-20 bg-white/80 dark:bg-gray-900/40 p-6 rounded-3xl shadow-neumorphic border border-gray-200/50 dark:border-white/10 backdrop-blur-xl">
